...
--
-- Table structure for table `audit_renta`
--

DROP TABLE IF EXISTS `audit_renta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `audit_renta` (
  `id_audit_renta` int NOT NULL AUTO_INCREMENT,
  `id_automovil` int NOT NULL COMMENT 'FK tabla automovil',
  `id_usuario` int DEFAULT NULL COMMENT 'FK tabla usuario para saber quien ha hecho la renta del auto',
  `fecha_creacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'fecha de creación',
  PRIMARY KEY (`id_audit_renta`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Log de renta de vehiculos';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `audit_renta`
--

LOCK TABLES `audit_renta` WRITE;
/*!40000 ALTER TABLE `audit_renta` DISABLE KEYS */;
INSERT INTO `audit_renta` VALUES (1,3,1,'2022-02-09 22:27:01'),(2,1,1,'2022-02-09 22:34:12');
/*!40000 ALTER TABLE `audit_renta` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de automoviles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `automovil` VALUES (1,'Toyota Yaris',1,61,2001,NULL,25,1,1,'2022-02-08 23:32:57','admin'),(2,'Onix 2005',2,60,2005,NULL,30,1,1,'2022-02-09 05:47:04','adminBD'),(3,'Toyota',1,132,2000,NULL,10,1,1,'2022-02-09 18:05:07','admin'),(5,'Toyota',1,192,2000,NULL,12,1,1,'2022-02-09 22:52:29','admin');
...
CREATE TABLE `rol` (
  ...
  PRIMARY KEY (`id_rol`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Rol de usuario';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rol` VALUES (1,'admin','Rol de administrador'),(2,'user','Rol de usuario');
...
CREATE TABLE `usuario` (
  ...
  `password` varchar(300) NOT NULL COMMENT 'Password del usuario para loquearse en el sistema',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de usuario';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'admin','$2a$12$9A1hyZKH.joIxtvSQEktluGycxtmyYFMRuVqDpW5psGrNMARKkSxu','Administrador','Del sistema','123456478','mail@mail.com',NULL,NULL,1,1),(2,'user','$2a$12$9A1hyZKH.joIxtvSQEktluGycxtmyYFMRuVqDpW5psGrNMARKkSxu','Usuario','Cliente','12345678','mail2@mail.com',NULL,NULL,1,2);
...
-- Dump completed on 2022-02-09 16:56:53
